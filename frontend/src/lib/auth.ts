...
class AuthService {
  ...
  getAccessToken(): string | null {
    ...
    console.log('AuthService: Getting access token:', token);
    return token;
  }

  setAccessToken(token: string): void {
    if (typeof window === 'undefined') return;
    console.log('AuthService: Setting access token:', token);
  ...
  getRefreshToken(): string | null {
    ...
    console.log('AuthService: Getting refresh token:', token);
    return token;
  }

  setRefreshToken(token: string): void {
    if (typeof window === 'undefined') return;
    console.log('AuthService: Setting refresh token:', token);
  ...
  clearTokens(): void {
    if (typeof window === 'undefined') return;
    console.log('AuthService: Clearing tokens and user data');
