...
export default function CompanyDetailPage() {
  ...
  // --- DÜZELTME 1: Fonksiyonlar useCallback içine alındı ---
  ...
  // --- DÜZELTME 2: Bağımlılık dizisi güncellendi ---
  useEffect(() => {
    fetchCompanyDetail()
    fetchBrands()
  }, [fetchCompanyDetail, fetchBrands])
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatNumber(company.brand_count || 0)}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatNumber(company.total_branches || 0)}
              </div>
              <p className="text-xs text-muted-foreground mt-1">
                Toplam şube sayısı
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatNumber(company.total_people || 0)}
              </div>
              <p className="text-xs text-muted-foreground mt-1">
                Toplam kişi sayısı
              </p>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{company.created_at ? formatDate(company.created_at) : '-'}</p>
                  </div>
                </div>
                {company.description && (
                  <div>
